...
class ChangePasswordViewController: UIViewController {
    ...
    @IBAction func changePasswordBtnTapped(_ sender: UIButton) {
        ...
        if self.isAllFieldsVerified() {
            ...
            params["old_password"] = self.userDetailsDict["Current Password"] as AnyObject
            params["new_password"] = self.userDetailsDict["New Password"] as AnyObject
            params["confirm_password"] = self.userDetailsDict["Confirm New Password"] as AnyObject
            params["action"] = "change" as AnyObject
            
            
            ServiceClass.updatePasswordApi(params, completionHandler: { (data) in
    ...
    func initialSetup() {
        ...
        self.navTitleLabel.text = CHANGE_PASSWORD.localized
    ...
    func isAllFieldsVerified() -> Bool {
        ...
        if (self.userDetailsDict["Current Password"] == nil) || (self.userDetailsDict["Current Password"] ?? "").isEmpty {
        ...
        } else if self.userDetailsDict["New Password"]!.characters.count < 6 {
        ...
        } else if (self.userDetailsDict["New Password"] == self.userDetailsDict["Current Password"]!) {
            
            showToastWithMessage(ChangePasswordStrings.notMatchPass)
            return false
            ...
            showToastWithMessage(ChangePasswordStrings.matchPass)
            return false
